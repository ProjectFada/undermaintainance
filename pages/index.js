...
export default function Index() {
  ...
  return (
    <>
      ...
      <div className="h-screen w-screen flex flex-col items-center justify-center p-5 stroke-primary fill-red-700">
        <svg viewBox="0 0 100 68" className="w-40 h-40">
          <g id="large">
        ...
        <h1 className="lg:text-3xl md:text-2xl text-xl font-bold text-primary">Under Maintenance</h1>
        <h2 className="lg:text-3xl md:text-2xl text-xl text-primary">We are sorry for the inconvenience. </h2>
      </div>
    </>
  );
}
